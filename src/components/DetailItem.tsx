...
import PosterOpen from "./PosterOpen";
        ...
        <div className="relative h-64 md:h-80 w-full overflow-hidden shrink-0">
          ...
          <div className="absolute bottom-0 left-6 md:left-8 flex gap-6 items-end z-10">
            <img
              ...
              className="w-36 md:w-44 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.8)] border-2 border-white/10 object-cover aspect-[2/3] cursor-pointer transition-transform duration-300 hover:scale-105"
            />
